          ...
          <div className={styles.last_result}>
            ...
            {ultimoResultado ? (
              <div className={styles.result_card}>
                <div>{ultimoResultado.timeMandante}</div>
                <div>
                  <strong>
                    <span>
                      {ultimoResultado.placarMandante} x{" "}
                      {ultimoResultado.placarVisitante}
                    </span>
                  </strong>
                </div>
                <div>{ultimoResultado.timeVisitante}</div>
              </div>
            ) : (
          ...
          <div className={styles.grid_noticias}>
            {noticias.map((noticia) => (
              <Link
                ...
                className={styles.card_noticia}
              >
                <img
                  src={noticia.imagem}
                  alt={noticia.titulo}
                  onClick={() =>
                    navigate(`https://localhost.8000/${noticia.id}`)
                  }
                />
